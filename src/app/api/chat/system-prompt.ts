...
1. provide a brief on what are you going to do, then call the extractQueryTool to extract a semantic query and criteria from their input
2. provide a brief on what are you going to do, then use the findCandidatesTool to search for matching candidates in the database
